...
\newglossaryentry{altura tonal}
{
    name=altura tonal,
    description={Orden de una nota en una escala}
}

\newglossaryentry{escala cromática}
{
    name=escala cromática,
    description={Escala musical conformada por 12 notas, siguiendo un patrón de 12 semitonos}
}