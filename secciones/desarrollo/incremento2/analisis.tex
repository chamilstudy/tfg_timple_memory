...
\begin{itemize}
    ...
    \item \textbf{Algoritmo de cálculo de diagramas de acordes:} dado un instrumento y un acorde, el algoritmo debe generar un diagrama del acorde que sea facilmente practicable y musicalmente correcto. 
\end{itemize}
