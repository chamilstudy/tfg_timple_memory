...
donde \(k\) es el número de cuerdas del instrumento y \(n_i\) representa la \gls{cuerda al aire} \(i\). De este modo, cada índice del vector corresponde a una cuerda del instrumento.

\textbf{En segundo lugar}, se representaron las combinaciones de \gls{traste}s posibles mediante un vector
...
\begin{enumerate}
    ...
    \item Se construye una \gls{escala cromática} tomando como \gls{tónica} la nota raíz del acorde.
    ...
    \item A partir del vector combinaciones, se generan las distintas combinaciones posibles de trastes, cada una representada mediante un vector \(D\)\ que corresponde a un diagrama de acorde.
\end{enumerate}
