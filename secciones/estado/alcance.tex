...
\begin{table}[H]
    ...
    \begin{tabular}{l p{0.58\textwidth} p{0.24\textwidth} l}
        ...
        RF13 & El usuario debe poder transportar los acordes de una publicación. & Utilidades en publicaciones & Media \\ \hline
        RF14 & El usuario debe poder ver guías de rasgueos. & Utilidades en publicaciones & Media \\ \hline
        RF15 & El usuario debe poder compartir publicaciones mediante enlace o redes sociales. & Utilidades en publicaciones & Media \\ \hline
        RF16 & El usuario debe poder imprimir o descargar una publicación. & Utilidades en publicaciones & Baja \\ \hline
        RF17 & El usuario debe poder comentar en publicaciones. & Funcionalidades en publicaciones & Media \\ \hline
        RF18 & El usuario debe poder puntuar una publicación. & Funcionalidades en publicaciones & Media \\ \hline
        RF19 & El usuario debe poder guardar canciones en su carpeta personal. & Funcionalidades en publicaciones & Baja \\ \hline

        % ---------------- Biblioteca ----------------
        RF20 & El usuario debe poder visualizar una biblioteca de canciones. & Biblioteca de canciones & Alta \\ \hline

        % ---------------- Calculadora de escalas y notas ----------------
        RF21 & El usuario debe poder acceder a una calculadora de escalas y notas. & Calculadora de escalas y notas & Alta \\ \hline

        % ---------------- Diccionario de acordes ----------------
        RF22 & El usuario debe poder acceder a un diccionario de acordes. & Diccionario de acordes & Alta \\ \hline

        % ---------------- Afinador ----------------
        RF23 & El usuario debe poder acceder a un afinador interactivo. & Afinador & Media \\ \hline
        RF24 & El afinador interactivo debe mostrar cuerdas, afinación objetivo y afinación actual. & Afinador & Alta \\ \hline

         % ---------------- Cursos y guías ----------------
        RF25 & El usuario debe poder acceder a páginas informativas sobre el instrumento. & Cursos y guías & Media \\ \hline
        ...
        RF30 & El sistema debe garantizar que cada diagrama generado sea físicamente ejecutable. & Cálculo de diagramas de acordes & Alta \\ \hline
    ...
    \end{tabular}
    \caption{Requisitos Funcionales de la aplicación web reorganizados por funcionalidad}\label{tab:requisitosfuncionales}
\end{table}
