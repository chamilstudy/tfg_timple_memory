...
\begin{itemize}
    ...
    \item Definir una nota inicial o \textbf{\gls{tónica}}.
    \item Seguir un patrón de distancias.
\end{itemize}

Además, podemos distinguir el concepto de \textbf{\gls{octava}} que es el intervalo de notas entre dos iguales \emph{e.g. de Do a Do'}. Este invervalo puede variar según la escala:
...
\begin{itemize}
    ...
    \item La \textbf{\gls{escala cromática}}, conformada por 12 notas siguiendo un patrón de 12 semitonos \tabref{tab:escala_cromatica}
