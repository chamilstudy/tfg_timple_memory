...
Existen un total de 12 notas, de las cuales 7 son naturales y 5 son \textbf{alteraciones}:
...
De este modo, obtenemos las notas naturales y sus alteraciones \figref{fig:piano_notas}.
...
Además, podemos definir un nuevo concepto, la distancia entre notas \tabref{tab:notas}:
...
Para construir un acorde debemos seleccionar una \textbf{\gls{modalidad}} que indicará los índices (en semitonos) de las notas \tabref{tab:acordes_modalidades}.

\begin{table}[H]
    \centering
    \caption{Modalidades de acordes}\label{tab:acordes_modalidades}
    \scriptsize
    \begin{tabular}{l c l}
        \hline
        \textbf{Modalidad} & \textbf{Símbolo} & \textbf{Semitonos} \\
        \hline
        Mayor & M & 0, 4, 7 \\
        Menor & m & 0, 3, 7 \\
        Aumentado & aug & 0, 4, 8 \\
...
Por tanto, para tocar el acorde de $Do Mayor$ (también conocido como DoM o simplemente $Do$), establecemos como tónica la nota $Do$, y seleccionamos las notas correspondientes a los índices 0, 4, 7: es decir, $Do$, $Mi$ y $Sol$ \figref{fig:piano_acorde_doM}.
...
Conocidos los conceptos de acorde y progresión, podemos introducir la \textbf{\gls{transposición}}. Dado un \textbf{acorde raiz}, podemos incrementar o decrementar sus índices para obtener sus equivalentes transpuestos. Si hablamos de una progresión, se incrementarán o decrementarán los indices de todos los acordes que forman la progresión \tabref{tab:transposicion_acordes_progresiones}.
