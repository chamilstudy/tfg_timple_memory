...
\begin{itemize}
    ...
    La existencia de esta aplicación web permite el acceso a cualquier persona a una gran cantidad de recursos para iniciarse, prácticar y aprender con el instrumento. La naturaleza social y retroactiva de la aplicación incentiva la creación de nuevos recursos ampliando el repertorio de contenidos, alimentando su proposito superior, la difusión del instrumento.
