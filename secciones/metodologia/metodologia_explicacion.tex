...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{Ilustraciones/metodologia/patton-incrementing-mona-lisa.jpg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{Ilustraciones/metodologia/patton-iterating-mona-lisa.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Ilustraciones/metodologia/iterative-incremental-mona-lisa.jpeg}
...
Una vez definidos los conceptos que conforman la metodología iterativa e incremental, podemos elaborar el proceso de desarrollo. Este debe incluir las principales \textbf{fases de desarrollo software}; análisis, diseño, desarrollo, pruebas y entrega. Llamamos \textbf{incremento} a cada repetición del proceso, que implica la implementación o mejora de una funcionalidad. Una vez finalizado el incremento, se entrega al usuario y se decide si es necesaria una nueva iteración \figref{fig:flujo_it_inc}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Ilustraciones/metodologia/flujo_it_inc.jpg}
    \caption{Flujo de desarrollo de la metodología iterativa e incremental}\label{fig:flujo_it_inc}
\end{figure}
